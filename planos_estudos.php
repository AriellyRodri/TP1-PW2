...
?>
<h1 class="page-title"><i class="fa-solid fa-list-check"></i> Plano de Estudos</h1>
...
<div class="card">
  ...
  <form method="POST">
    <div class="form-row" style="grid-template-columns:2fr 2fr 1fr 1fr auto;">
      ...
      <div class="form-group" style="margin-bottom:0;display:flex;align-items:flex-end;">
        <button class="btn btn-primary" type="submit" name="add" style="white-space:nowrap;">
